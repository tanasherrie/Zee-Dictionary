<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminsignup.aspx.cs" Inherits="ZeeFSLDictionary.Pages.Admin.WebForm2" %>
...
<body>
    <form id="login" runat="server">
        <div  class="container jumbotron bg-light" id="login_id" style="width:35%">
		        ...
		        <h2 id="login_header">Admin Sign Up</h2>
            ...
            <br />
            <div align="center">
                <asp:LinkButton ID="LinkButton1" runat="server" href="adminlogin.aspx" CssClass="btn btn-link">Have an account? Login</asp:LinkButton>
            </div>
        </div>
    </form>             
</body>
