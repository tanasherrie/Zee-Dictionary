<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adduser.aspx.cs" Inherits="ZeeFSLDictionary.Pages.Admin.WebForm3" %>
...
<body>
    <form id="form1" runat="server">
                      ...
                      <form>
                        <div class="modal-body">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="usertype" placeholder="Enter usertype"/>
                          </div>
                            <div class="form-group">
        ...
        <div class="sidenav"><br /><br />
            ...
            <asp:LinkButton ID="LinkButton2" runat="server" style="color:white">Admin</asp:LinkButton><br />
            <asp:LinkButton ID="LinkButton3" runat="server" style="color:white">Deaf Users</asp:LinkButton><br />
            <asp:LinkButton ID="LinkButton4" runat="server" style="color:white">Hearing Users</asp:LinkButton>
